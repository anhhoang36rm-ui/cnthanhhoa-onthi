...
# Mật khẩu quản trị: lưu bền vững ra DB/file để admin có thể tự đổi mật khẩu.
# Nếu chưa có, dùng mật khẩu mặc định "admin123".
...
# Lưu bền vững các câu hỏi đã thi của từng tài khoản cho từng bộ đề,
...
{% endif %}
<button class="reject" type="submit" name="action" value="reject" onclick="return confirm('Bạn có chắc muốn từ chối tài khoản me này?')">Từ chối</button>
